...
export default function MeProfile() {
    ...
    const handleCityChange = (value: any) => {
        ...
        // setProfile({ city: value });
    };

    const handleDistrictChange = (value: any) => {
        setSelectedDistrict(value);
        setWards([]);
        //  setProfile({ province: value });
        const selectedCityData = cities.find((city: any) => city.Name === selectedCity);
        const selectedDistrictData = selectedCityData?.Districts.find((province: any) => province.Name === value);
