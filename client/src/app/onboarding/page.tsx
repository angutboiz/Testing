...
import { RegisterDetailBody, RegisterDetailType } from "@/schemaValidations/auth.schema";
...
export default function MeProfile() {
    ...
    async function onSubmit(values: RegisterDetailType) {
        ...
        formData.append("firstName", values.lastname.charAt(0).toUpperCase() + values.lastname.slice(1));
        formData.append("lastName", values.firstname.charAt(0).toUpperCase() + values.firstname.slice(1));
        formData.append("city", values.provine);
        formData.append("province", values.district);
        formData.append("address", values.ward);
        formData.append("phoneNumber", values.phonenumber);
        formData.append("birthday", new Date(values.date).toISOString().slice(0, 10));
