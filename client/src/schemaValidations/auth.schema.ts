  ...
  .object({
    ...
    phonenumber: z
      ...
      .regex(
        ...
        "Số điện thoại phải bắt đầu bằng số 0 và có tổng cộng 10 chữ số - theo chuẩn điện thoại Việt Nam"
      ),
    date: z
      .string()
      .min(5, "Vui lòng nhập ngày sinh")
...
export const RegisterThreeBody = z
  .object({
    username: z
      .string()
      .trim()
      .min(5, "Tên tài khoản phải trên 5 kí tự")
      .regex(/^\S*$/, "Tên tài khoản không được chứa khoảng trắng")
      .max(256, "Tên tài khoản không được vượt quá 256 ký tự"),
    ...
    email: z
      ...
      .regex(
        /^[^@]+@[^@]+\.[^@]+$/,
        "Email phải chứa ký tự '@' và có domain hợp lệ"
      ),
    password: z
      .string()
